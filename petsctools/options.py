...
class AppContextKey(str):
    ...
    will be generated as needed by the :class:`.Options`.
...
class Options(PETSc.Options):
    ...
    prefix :
        ...
        i.e. ``Options("prefix_")["option"]`` is equivalent to
    ...
    def __init__(self, prefix: str | None = None) -> None:
        super().__init__(_validate_prefix(prefix or ""))

    def _appctx_key_from_option(self, option: str) -> AppContextKey:
        """
        ...
        """
        return AppContextKey(self.getString(self.prefix + option))
    ...
    def __setitem__(self, option: str | AppContextKey, value: Any, /) -> None:
        ...
        if option.endswith("python_type") and isinstance(value, type):
